    ...
    <div className="flex flex-col gap-[50px]">
      <div className="custom_container flex flex-col md:flex-row items-center gap-[30px] md:gap-[100px]">
        ...
        <div className="w-full p-3">
          <h2 className="text-[30px] md:text-[40px] text-black mb-[10px]">Let’s Start Shipping</h2>
          <p className="mb-[1.5rem] text-[20px] text-black">You have parcels. We’ll take care of them.</p>
          <Link href="/" className="max-w-max h-[45px] p-3 hidden items-center justify-center gap-3 rounded-[2.5rem] bg-[#ffc400] hover:bg-[#ffc400] text-base font-semibold text-black">
      ...
      <div className="custom_container flex flex-col-reverse md:flex-row items-center gap-[30px] md:gap-[100px]">
        <div className="w-full p-3">
          <h2 className="text-[30px] md:text-[40px] text-black mb-[10px]">Manage All Your Shipments In One Place</h2>
