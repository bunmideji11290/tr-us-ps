  ...
  return (
    <div className="w-full p-[16px] pb-[80px] text-[#333333]">
      <div className="max-w-[1000px] mx-auto">
        ...
        <div className="p-4 rounded bg-[#333366] text-white mb-[30px] mt-[30px] text-center font-semibold">Tracking Number: [{packageInfo.tracking_number}] found.</div>
        <div className="border p-4 md:p-8 rounded-lg">
            ...
            <div>
              <div className="relative overflow-x-auto">
                <table className="w-full text-sm text-left">
                  <thead className="text-xs text-white uppercase border-b bg-[#333366]">
                    <tr>
          ...
          <div>
            ...
            <div>
              <div className="bg-[#333366] hidden text-white items-center justify-between">
              ...
              <div className="bg-[#333366] text-white flex items-center justify-between">
